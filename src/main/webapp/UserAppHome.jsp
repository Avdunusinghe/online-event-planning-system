  ...
  <main id="main">
        ...
        <div class="row">
          ...
          <div class="col-lg-6" align = "center">  
              ...
              <p> The Event Planner Ltd is an event logistics and marketing company that was formed back in 2013. 
                The company offers A-Z event planning services from a team of experienced and energetic event planners, suppliers, 
                venues, and more. One of the main reasons behind the success of The Event Planner Ltd is the fact that the team does not 
                charge fees to its clients! With the number of events we organize, The Event Planner Ltd does not need to add exorbitant fees 
                and mark-ups to make its profit margins. This ensures that our client's list, which is constantly growing, makes regular 
    ...
    <section id="speakers">
      <div class="container" data-aos="fade-up">
        <div class="section-header">
          ...
          <p>Here are some of our Planners</p>
        </div>
    ...
    <section id="schedule" class="section-with-bg">
      <div class="container" data-aos="fade-up">
        ...
        <h3 class="sub-heading">No, nor will occur, I will come to achieve the functions of the feeble and corrupt, pleasure. 
                                The needs of the labor of his encounter because it is the pleasure of a man.</h3>
        ...
        <div class="tab-content row justify-content-center" data-aos="fade-up" data-aos-delay="200">
          ...
          <div role="tabpanel" class="col-lg-9 tab-pane fade show active" id="day-1">
            ...
            <div class="row schedule-item">
              ...
              <div class="col-md-10">
                <h4>Registration</h4>
                <p>The pleasure of the righteous ancestors fled the times and will never be a great victory.</p>
              </div>
            </div>
            ...
            <div class="row schedule-item">
              ...
              <div class="col-md-10">
                ...
                <p>To do betake himself the pleasure of which they are incident.</p>
              </div>
            </div>
            ...
            <div class="row schedule-item">
              ...
              <div class="col-md-10">
                ...
                <p>The greater ones are worthy of neither is he that was invented in order to be with the accusing.</p>
              </div>
            </div>
            ...
            <div class="row schedule-item">
              ...
              <div class="col-md-10">
                ...
                <p>My toil, and of denouncing them, nothing will come of denouncing puffeth at them.</p>
              </div>
            </div>
            ...
            <div class="row schedule-item">
              ...
              <div class="col-md-10">
                ...
                <p>In fact, the distinction between pleasure and pain, of takes with the just.</p>
              </div>
            </div>
            ...
            <div class="row schedule-item">
              ...
              <div class="col-md-10">
                ...
                <p>Will happen to us, and to the times in which it is to choosing the wide unpopularity.</p>
              </div>
            </div>
          ...
          <div role="tabpanel" class="col-lg-9  tab-pane fade" id="day-2">
            ...
            <div class="row schedule-item">
              ...
              <div class="col-md-10">
                ...
                <h4>Quo qui praesentium nesciunt <span>Willow Trantow</span></h4>
                <p>But pleasure is or whether there is in fact that neither of the truth, and the other of sorrows.</p>
              </div>
            </div>
      ...
      <div class="container-fluid" data-aos="fade-up">
        ...
        <div class="row no-gutters">
          <div class="col-lg-6 venue-map">
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d104555.3088462158!2d79.8859171473016!3d6.878854224536603!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3ae2596b97e6c977%3A0x227a2d2db9a6702f!2s117%2C%208%20Hunupitiya%20Lake%20Rd%2C%20Colombo!5e0!3m2!1sen!2slk!4v1620141401127!5m2!1sen!2slk" frameborder="0" style="border:0" allowfullscreen></iframe>
          </div>

          <div class="col-lg-6 venue-info">
            <div class="row justify-content-center">
              <div class="col-11 col-lg-8">
                <h3>Main Branch <br> SRI LANKA</h3>
                <p>An event is something exciting, memorable, and unique to the event owner & most of the time it is a dream. Today, the ideas of people are very advanced through the time factor matters with their busy schedule. However, the success of a dream can become invaluable for the happiness of the dreamer.
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row" data-aos="fade-up" data-aos-delay="100">
          ...
          <div class="col-lg-4 col-md-6">
            <div class="hotel">
              <div class="hotel-img">
                <img src="assets/img/hotels/a.jpg" alt="Hotel 1" class="img-fluid">
              </div>
          ...
          <div class="col-lg-4 col-md-6">
            <div class="hotel">
              <div class="hotel-img">
                <img src="assets/img/hotels/b.jpg" alt="Hotel 2" class="img-fluid">
              </div>
          ...
          <div class="col-lg-4 col-md-6">
            <div class="hotel">
              <div class="hotel-img">
                <img src="assets/img/hotels/c.jpg" alt="Hotel 3" class="img-fluid">
              </div>
    ...
    <section id="buy-tickets" class="section-with-bg">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-header">
          <h2>Buy Tickets</h2>
          <p>From which shuns the consequences of this all for Him and choose to achieve its discoverer.</p>
        </div>
    ...
    <section id="contact" class="section-bg">
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row contact-info">
          ...
          <div class="col-md-4">
            <div class="contact-address">
              ...
              <h3>Address</h3>
              <address>117/8 Hunupitiya lake,Colombo 02,Sri Lanka.</address>
            </div>
          </div>
          ...
          <div class="col-md-4">
            <div class="contact-phone">
              ...
              <h3>Phone Number</h3>
              <p><a href="tel:+155895548855">+94 11 2 123 123</a></p>
            </div>
          </div>
          ...
          <div class="col-md-4">
            <div class="contact-email">
              ...
              <h3>Email</h3>
              <p><a href="mailto:info@example.com">theevent@gmail.com</a></p>
            </div>
          </div>
        ...
        <div class="form" class="needs-validation" nonvalidate>
          <form action="ContactInsertServlet" method="post" role="form" class="contactform">
            <div class="form-row">
...
<div id="logo" class="pull-left">
          ...
          <div class="col-lg-3 col-md-6 footer-contact">
            <h4>Contact Us</h4>
            <p>
              117/8 Hunupitiya lake <br>
              Colombo 02 <br>
              Sri Lanka<br>
              <strong>Phone:</strong> +94 11 2 123 234 <br>
              <strong>Email:</strong> theeventplanner@gmail.com <br>
            </p>
...
>>>>>>> branch 'master' of https://github.com/Avdunusinghe/online-event-planning-system.git
</html>